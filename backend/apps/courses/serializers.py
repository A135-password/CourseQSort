...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = ['id', 'student_no', 'name', 'major', 'major_name',
                  'grade', 'class_identification', 'class_group', 'class_name']
...
class CourseAssignmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'course', 'major', 'major_name', 'grade',
                  'class_identification', 'created_at']
