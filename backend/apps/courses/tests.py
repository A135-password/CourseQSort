    ...
    def test_import_endpoint_creates_courses_and_links_teachers(self):
        upload = self._build_excel_upload([
            [
                ...
                'major', 'teacher', 'expected_student_count', 'is professional',
            ],
            [
                'Medical Statistics', 'MED101', 3, 48, '2026-1',
                'Clinical Medicine', 'Teacher One, Teacher Two', 80, 'true',
            ],
            [
                'Broken Course', 'MED102', 'bad-credit', 32, '2026-1',
                'Clinical Medicine', 'Teacher Three', 40, 'true',
            ],
        ])
