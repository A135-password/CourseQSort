...
class ConflictPair(models.Model):
    result = models.ForeignKey(
        ConflictAnalysisResult, on_delete=models.CASCADE,
        related_name='pairs'
    )
    course_a = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name='conflict_a'
    )
    course_b = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name='conflict_b'
    )
...
class ConflictTaskRecord(models.Model):
    ...
    result = models.ForeignKey(
        ConflictAnalysisResult, on_delete=models.SET_NULL,
