...
class ScheduleEntry(models.Model):
    plan = models.ForeignKey(SchedulePlan, on_delete=models.CASCADE, related_name="entries")
...
class TaskRecord(models.Model):
    ...
    plan = models.ForeignKey(SchedulePlan, on_delete=models.SET_NULL, null=True, blank=True)
